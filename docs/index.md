...
| SDK as a product (crates.io/PyPI packages, echo example, conformance runner) | shipped | v0.4-dev | `switchyardctl plugin test` green on echo + potatomesh; publish pending registry tokens |
